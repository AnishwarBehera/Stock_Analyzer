...
#                             # Some pages may have multiple tables
#                             if table:
#                                 df = pd.DataFrame(table[1:], columns=table[0])
#                                 tables.append(df)
#                 if tables:
#                     print("Tables detected using pdfplumber.")
#                     return tables
#         except Exception as pdfplumber_error:
#             print(f"Error using pdfplumber: {pdfplumber_error}")
...
#         # 3. OCR-based extraction using PyMuPDF and Tesseract
#         try:
#             print("Attempting OCR-based extraction...")
#             images = convert_from_path(temp_pdf_path)
#             ocr_data_frames = []
#             for page_num, image in enumerate(images):
#                 image_np = np.array(image)
#                 ocr_text = pytesseract.image_to_string(image_np, config='--oem 3 --psm 6')
